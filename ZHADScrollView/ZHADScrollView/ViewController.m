...
- (void)viewDidLoad {
    ...
    _adScrollView.translatesAutoresizingMaskIntoConstraints=NO;
    ...
    [v1 addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[v1]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(v1)]];
    [v1 addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_adScrollView]-20-[v1(20)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_adScrollView,v1)]];
}
